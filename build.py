...
def preview_styles():
    ...
    return (
        ...
        # WHY: имена css-бандлов екома с хешем и меняются при каждой их выкатке.
        # Когда файл пропадает, мок шапки остаётся без стилей и превращается
        # в голый список ссылок — так лендинг и открывался у всех, кому дали ссылку.
        # Ссылки помечены onerror: не загрузились — мок просто не показываем.
        '.lp-no-ecom-css .lp-ecom-chrome{display:none}'
        '</style>')
